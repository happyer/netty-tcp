...
public enum MessagId {
    ...
    TERMINAL_GET_PARAMETER(0x8104), TERMINAL_PARAMETER_RESPONSE(0x0104), CONTROL_TERMINAL(0X8105), LOCATION_REPORT(0x0200);
    ...
    public static MessagId getVal(int val) {
        for (MessagId messagId : values()) {
